...
It is a board casual game. The objective is to select the numbers in the board to increment the score and defeat the AI. It's running live [here](https://sosegon.github.io/numbers/).
...
Documentation can be found [here](https://sosegon.github.io/numbers/docs).
